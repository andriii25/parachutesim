...
non_ambiance_alt = {90000: 2.85e-6, 95000: 9.91e-7, 100000: 3.73e-7, 105000: 1.54e-7, 110000: 5.93e-8, 115000: 2.71e-8, 120000:1.48e-8 }   #measured high altitude densities from attached paper
...
while current_height > 1000:
  ...
  dp.append(dp1)
  Dt.append(D)
  Fd = 1/2 * current_density(h[index]) * (v[index])**2 * 0.03
  Findrag.append(Fd)
...
plt.plot(h, Findrag, label='Findrag')
plt.xlabel('$Height /m$')
plt.ylabel('$Drag N$')
plt.legend()
plt.show()